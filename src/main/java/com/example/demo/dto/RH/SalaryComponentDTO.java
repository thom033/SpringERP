...
public class SalaryComponentDTO {
    ...
    public SalaryComponentDTO(String salary_component, String salary_component_abbr, String type, String formula, String amount_based_on_formula, String depends_on_payment_days, String company) {
